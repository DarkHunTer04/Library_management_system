          ...
          <ul class="navbar-nav ms-auto">
            ...
            <li class="nav-item dropdown">
              ...
              <ul class="dropdown-menu" aria-labelledby="navbarDropdown">
                <li><a class="dropdown-item" href="addlibrarian.php">Add New Librarian</a></li>
                <li><a class="dropdown-item " href="managelibrarian.php">Manage Librarian</a></li>
