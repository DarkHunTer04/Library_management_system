    ...
    <?php
        ...
        $query_run=mysqli_query($con,$query);
               ...
               <tr>
                     ...
                     <td><img src="../admin/bookimg/<?= $issuebook['bookImage'];?>" width="100"></td>
                     <td><?= $issuebook['issue_date'];?></td>
                     <td><?= $issuebook['return_date'];if($issuebook['return_date']=='')
                    {
                    echo "Not yet Returned";
                    }?></td>
                    <td><button><a href="return.php?id=<?php echo $issuebook["id"];?>" class="btn btn-success btn-sm">Return</a></button>
